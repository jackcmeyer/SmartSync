 ...
 *
 * The update user preferences dto
 */
public class UpdateUserPreferencesDTO {
    ...
    public UpdateUserPreferencesDTO(Long id, Long userId, String name, String primaryColor, String secondaryColor,
                                    String accentColor, String neutralLightColor, String neutralDarkColor) {
        this.id = id;
        this.userId = userId;
        this.name = name;
